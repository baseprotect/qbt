...
OutputDir=bin
OutputBaseFilename=Install_BPQBT_{#JoinerGetSuffix()}
...
[Files]
Source: "..\qbittorrent-build-desktop-Qt_4_8_5__4_8_5__Release\src\release\qbittorrent.exe"; DestDir: "{pf}/BaseprotectQBT"; Flags: ignoreversion
...
Source: "*.dll";  DestDir: "{pf}/BaseprotectQBT"; Flags: ignoreversion
